...
fname ='/Users/simon/Code/CONFIGS/BAKER_G1A_2/rip_his.nc';
nc=netcdf(fname);
h=nc{'h'}(1,:);
x=nc{'x_rho'}(1,:);
...
load ./BAKER_G1D_Specnn_innerSZ

semilogy(BAKER_G1D_Specnn_innerSZ(:,1),BAKER_G1D_Specnn_innerSZ(:,2));
hold on
semilogy(f,smooth(See,5)/5)
