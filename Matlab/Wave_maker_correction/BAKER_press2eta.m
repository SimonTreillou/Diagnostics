function [eta] = BAKER_press2eta(press,Fs,offset,maxfac)
    % from https://github.com/cmbaker94/trc_lab_experiment/blob/main/toolbox/press2sse_timeseries.m
    ...
    [temp, iloc]    = min(abs(ffilt-maxfac));
