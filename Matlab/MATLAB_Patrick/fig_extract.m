...
fprintf(fid0,'(A figure legend may generate extra x-y data sets with only one or two rows.)\n'); 
...
fprintf(fid0,'All the x series in the figure are found to be the same.\n');
fprintf(fid0,' x\t');
    for i=1:n
    fprintf(fid0,' y%g\t',i);
    end
